...
class TargetPosePublisher:public rclcpp::Node{
    ...
    private:
        void publishTargetPose()
        {
            ...
            target_pose_msg.position.x =  0.3069  + pose_received_.pose.position.x;
            target_pose_msg.position.y =  0.0000  + pose_received_.pose.position.y;
            target_pose_msg.position.z =  0.4703  + pose_received_.pose.position.z;
